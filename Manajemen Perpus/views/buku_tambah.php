                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-9">
                                <select name="loker_buku" class="form-control">
                                    ...
                                    <option value="Buku Pembelajaran">Buku Sejarah</option>
                                </select>
                            </div>
                        </div>
						<div class="form-group">
...
if ($_POST) {
    ...
    // SQL Insert - Sebutkan kolomnya dan nilai-nilai yang ingin dimasukkan
    $sql = "INSERT INTO buku (
                loker_buku, no_rak, no_laci, no_boks, judul_buku,
                nama_pengarang, tahun_terbit, penerima, penerbit, status, keterangan
            ) VALUES (
                '$lokerbuku', '$rak', '$laci', '$boks', '$judulbuku',
                '$pengarang', '$tahun_terbit', '$penerima', '$penerbit', '$status', '$ket'
            )";
