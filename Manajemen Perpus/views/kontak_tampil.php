            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="deskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <label class="col-sm-12 control-label"><center><br><strong>PERPUSTAKAAN FASILKOM</strong></center><br></label>
                            <p align="center">
                        ...
                        <tbody>
                            ...
                            <br>
                            Telp. 12345678<br>
                            Email : perpusfasilkom@unsika.ac.id<br>
                            Fax : 1234567<br>
                            Website : perpusfasilkom.ac.id<br>
                            </div>
                            <div class="col-sm-2" align="center">
                            </div>
                        </tbody>
