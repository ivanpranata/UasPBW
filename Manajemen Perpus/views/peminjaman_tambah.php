...
if($_POST){
    ...
    $judulbuku = $_POST['judulbuku'];  // sesuaikan nama variabel
    $peminjam  = $_POST['peminjam'];
    $tglPinjam = $_POST['tglPinjam'];
    $ket       = $_POST['ket'];

    // Buat sql insert (pastikan urutan kolom di tabel sesuai)
    $sql = "INSERT INTO peminjaman (judul_buku, peminjam, tgl_pinjam, tgl_kembali, lama_pinjam, keterangan) 
        VALUES ('$judulbuku', '$peminjam', '$tglPinjam', 'Belum Kembali', 0, '$ket')";
